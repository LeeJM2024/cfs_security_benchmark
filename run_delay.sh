...
LOG="${LOG:-reports/rf_link_delay_screenshot.jsonl}"
OUT="${OUT:-reports/rf_link_delay_screenshot.out}"
HOST_UID="$(id -u)"
HOST_GID="$(id -g)"
COSMOS_PID=""
...
echo "      scenario:    scenarios/rf_link/link_delay.yaml"
...
echo "Delay is configured in scenarios/rf_link/link_delay.yaml."
echo
