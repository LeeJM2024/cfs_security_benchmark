...
from benchmark_engine.rf_link.proxy import Endpoint, EventLog, RfLinkProxy
...
def main() -> None:
    ...
    parser.add_argument("--log", type=Path, default=Path("artifacts/reports/rf_link_transparent.jsonl"), help="JSONL event log")
