...
def main() -> None:
    parser = argparse.ArgumentParser(description="Install all registered benchmark prerequisites into NOS3")
    ...
    raise SystemExit(0 if run_lifecycle(action="prep", nos3_root=args.nos3_root, domains=args.domains, dry_run=args.dry_run) else 1)
