...
LOG="${LOG:-artifacts/reports/rf_link_replay_screenshot.jsonl}"
OUT="${OUT:-artifacts/reports/rf_link_replay_screenshot.out}"
HOST_UID="$(id -u)"
HOST_GID="$(id -g)"
COSMOS_PID=""
...
echo "      scenario:    security_suites/rf_link/scenarios/link_replay.yaml"
...
echo "Replay repeats/spacing are configured in security_suites/rf_link/scenarios/link_replay.yaml."
echo
