...
.ats = {
    ...
    .cmd1.CmdHeader  = CFE_MSG_CMD_HDR_INIT(SC_CMD_MID, SC_MEMBER_SIZE(cmd1), SC_RESET_COUNTERS_CC, SC_RESET_COUNTERS_CKSUM),
...
CFE_TBL_FILEDEF(SC_Ats1, SC.ATS_TBL1, SP004 ATS1, sp004_sc_ats1.tbl)
