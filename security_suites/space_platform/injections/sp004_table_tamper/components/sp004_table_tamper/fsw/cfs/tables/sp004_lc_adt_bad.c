...
static CFE_TBL_FileDef_t CFE_TBL_FileDef
    __attribute__((__used__)) = {"LC_DefaultADT", LC_APP_NAME "." LC_ADT_TABLENAME, "SP004 LC ADT",
                                 "sp004_lc_adt.tbl", (sizeof(LC_ADTEntry_t) * LC_MAX_ACTIONPOINTS)};
