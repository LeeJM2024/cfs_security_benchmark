...
CF_ConfigTable_t SP004_CF_ConfigBad = {
    10,    /* ticks_per_second */
    16384, /* max number of bytes per wakeup to calculate r2 recv file crc */
    125,   /* local entity id tampered by SP004 */
...
CFE_TBL_FILEDEF(SP004_CF_ConfigBad, CF.config_table, SP004 CF, sp004_cf_cfg.tbl)
